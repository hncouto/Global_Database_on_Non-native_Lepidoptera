...
# Considering that there were only 33 taxonomy cases, corresponding to only 46 records, that could not be resolved by the applied methodology it was opted to drop these cases. 
